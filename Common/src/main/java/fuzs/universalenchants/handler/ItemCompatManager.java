...
public class ItemCompatManager {
    ...
    private static final ExtendedEnchantmentCategory SWORD = new ExtendedEnchantmentCategory(item -> item instanceof SwordItem, () -> UniversalEnchants.CONFIG.get(ServerConfig.class).itemCompatibility.swordEnchantments, () -> UniversalEnchants.CONFIG.get(ServerConfig.class).itemCompatibility.swordBlacklist);
    private static final ExtendedEnchantmentCategory AXE = new ExtendedEnchantmentCategory(item -> item instanceof AxeItem, () -> UniversalEnchants.CONFIG.get(ServerConfig.class).itemCompatibility.axeEnchantments, () -> UniversalEnchants.CONFIG.get(ServerConfig.class).itemCompatibility.axeBlacklist);
    private static final ExtendedEnchantmentCategory TRIDENT = new ExtendedEnchantmentCategory(item -> item instanceof TridentItem, () -> UniversalEnchants.CONFIG.get(ServerConfig.class).itemCompatibility.tridentEnchantments, () -> UniversalEnchants.CONFIG.get(ServerConfig.class).itemCompatibility.tridentBlacklist);
    private static final ExtendedEnchantmentCategory BOW = new ExtendedEnchantmentCategory(item -> item instanceof BowItem, () -> UniversalEnchants.CONFIG.get(ServerConfig.class).itemCompatibility.bowEnchantments, () -> UniversalEnchants.CONFIG.get(ServerConfig.class).itemCompatibility.bowBlacklist);
    private static final ExtendedEnchantmentCategory CROSSBOW = new ExtendedEnchantmentCategory(item -> item instanceof CrossbowItem, () -> UniversalEnchants.CONFIG.get(ServerConfig.class).itemCompatibility.crossbowEnchantments, () -> UniversalEnchants.CONFIG.get(ServerConfig.class).itemCompatibility.crossbowBlacklist);
    ...
    private static class EnchantmentCategoryData {
        ...
        private static synchronized EnchantmentCategory getOrBuildCategory(Enchantment enchantment, Predicate<Item> canApplyTo) {
            ResourceLocation enchantmentKey = Registry.ENCHANTMENT.getKey(enchantment);
