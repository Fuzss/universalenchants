...
public class ServerConfig implements ConfigCore {
    ...
    @Config(category = "enchantment_improvements", description = {"Remove the max level cap from the /enchant command, also allow overriding existing enchantment levels.", "Additionally make enchanting books work via the command."})
