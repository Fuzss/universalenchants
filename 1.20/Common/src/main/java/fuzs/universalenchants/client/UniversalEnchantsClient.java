...
import fuzs.universalenchants.client.core.ClientAbstractions;
...
public class UniversalEnchantsClient implements ClientModConstructor {
    ...
    public void onRegisterResourcePackReloadListeners(AddReloadListenersContext context) {
        context.registerReloadListener("roman_numerals", resourceManager -> {
            NumericClientLanguage.injectLanguage(ClientAbstractions.INSTANCE.getNumericClientLanguage());
        });
    }
}
